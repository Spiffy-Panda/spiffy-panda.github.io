...
Before the AI work, I built interactive systems: graphics, VR and AR, game feel, and the maths underneath them. These are the projects that taught me to instrument something before believing it, which is the habit the newer work runs on.

# [[personal_projects/IK|Inverse Kinematics]]
#### Core Skills:
[[tags/lang/C_sharp]] [[tags/engine/unity]] [[tags/robotics]] [[tags/3d_mathematics]]

<img src="/assets/MultiArmIK.png" alt="Multi-arm IK" style="width: 30%; opacity: 0.7; float: right; margin: 20px; border: 5px solid black" />
...
<img src="/assets/CIE_LChab_StraightLine.jpg" alt="CIE LCh straight line" style="width: 30%; opacity: 0.7; float: right; margin: 20px; border: 5px solid black" />
